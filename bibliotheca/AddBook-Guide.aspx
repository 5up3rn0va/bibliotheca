<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBook-Guide.aspx.cs" Inherits="bibliotheca.AddBook_Guide" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Add Exam Guides</title>
    <!-- Meta tag Keywords -->
...
<body>
    ...
    <main id="main">
        ...
        <div class="form">
            ...
            <div class="input_field">
                <label>Exam</label>
                <asp:DropDownList ID="ddlExam" runat="server" DataSourceID="SqlDataSource2" DataTextField="exam_name" DataValueField="exam_id"></asp:DropDownList>
                
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:aspprojConnectionString %>" SelectCommand="SELECT [exam_name], [exam_id] FROM [tbl_exams]"></asp:SqlDataSource>
                
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlExam" InitialValue="0" ErrorMessage="Select exam" />
            </div>
            <div class="input_field">
