<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileB.aspx.cs" Inherits="bibliotheca.Profile" %>
    ...
    <div class="container rounded bg-white mt-5">
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="assets/img/User Icon.png" width="90"></div>
            </div>
            <div class="col-md-8">
                <div class="p-3 py-5">
