<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBook-Text.aspx.cs" Inherits="bibliotheca.AddBook_Text" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add TextBooks</title>
    <!-- Meta tag Keywords -->
     ...
     <!-- ======= Header ======= -->
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <ul>
              ...
              <li><asp:LinkButton ID="lbtnSignout" runat="server" OnClick="lbtnSignout_Click1" >Sign out</asp:LinkButton></li>
            </ul>
          </li>
            </ul>
    ...
    <main id="main">
        ...
        <div class="form">
            ...
            <div class="input_field">
                ...
                <asp:DropDownList ID="ddlDept" runat="server" DataSourceID="SqlDataSource2" DataTextField="dept_name" DataValueField="dept_id"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:aspprojConnectionString %>" SelectCommand="SELECT [dept_name], [dept_id] FROM [tbl_departments]"></asp:SqlDataSource>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlDept" InitialValue="0" ErrorMessage="Select department" />
            </div>
            <div class="input_field">
