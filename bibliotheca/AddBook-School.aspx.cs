...
{
    public partial class AddBook_School : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = new SqlCommand("insert into tbl_school_books values(@book_id, @board_id, @class, @subject_id)", con.Setconnection());
            cmd2.Parameters.AddWithValue("book_id", bid);
            cmd2.Parameters.AddWithValue("board_id", ddlBoard.SelectedValue);
            cmd2.Parameters.AddWithValue("class", ddlClass.SelectedValue);
            cmd2.Parameters.AddWithValue("subject_id", ddlSubject.SelectedValue);
